  ...
  return (
    <div className="flex justify-center w-full min-h-full py-5 px-2">
      <div className="flex flex-col w-full px-4 space-y-4 h-fit bg-orange-200 sm:w-[635px] border-none rounded-md py-3">
        ...
        <InputField label="Skill" name="skill1" type="text" placeholder="Skill" />
        <InputField label="Skill" name="skill2" type="text" placeholder="Skill" />
        <InputField label="Skill" name="skill3" type="text" placeholder="Skill" />
